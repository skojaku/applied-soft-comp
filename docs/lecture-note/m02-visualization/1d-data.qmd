...
![](https://simplystatistics.org/posts/2019-02-21-dynamite-plots-must-die/index_files/figure-html5/dynamite-1.png){width="50%" fig-align="center" }
...
```{python}
#| fig-cap: "Swarm plot: Every point visible"
#| fig-width: 12
#| fig-height: 10
#| code-fold: true
...
```{python}
#| fig-cap: "Strip plot with jittering"
#| fig-width: 12
#| fig-height: 10
#| code-fold: true
...
```{python}
#| fig-cap: "Histogram: Distribution Comparison"
#| fig-width: 12
#| fig-height: 10
#| code-fold: true
...
```{python}
#| fig-cap: "Kernel Density Estimate"
#| fig-width: 12
#| fig-height: 10
#| code-fold: true
...
```{python}
#| fig-cap: "Cumulative Distribution Function"
#| fig-width: 12
#| fig-height: 10
#| code-fold: true
...
```{python}
#| fig-cap: "Complementary Cumulative Distribution Function"
#| fig-width: 12
#| fig-height: 10
#| code-fold: true
