...
This module teaches you how to visualize one-dimensional data honestly and clearly. You'll discover why hiding raw data behind summary statistics is misleading, learn practical tools like swarm plots and kernel density estimation, and understand how to choose the right visualization for your dataset's size and characteristics.
:::
...
- @weissgerber2015bar - The paper that started the "show your data" movement
- @weissgerber2016data
