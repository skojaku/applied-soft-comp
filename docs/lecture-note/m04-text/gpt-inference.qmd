...
Notice how: Low temperature (τ = 0.1) produces conservative, focused output. Medium temperature (τ = 1.0) provides balanced diversity. High temperature (τ = 5.0) produces creative but potentially incoherent output.
