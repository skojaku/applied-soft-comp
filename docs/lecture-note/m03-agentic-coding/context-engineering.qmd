...
::: {#fig-context-rot}
![Context rot degrades attention as token count increases](../figs/context-engineering-context-rot-manga.png){width="70%" fig-align="center"}
:::
...
::: {#fig-mcp-illustration}
![Model Context Protocol enables on-demand data retrieval](../figs/context-engineering-chibi-mcp.png){width="70%" fig-align="center"}
:::
...
::: {#fig-mcp-config layout-ncol=1}
![Digital Garden MCP interface](../figs/screenshot_2025-12-01_digital_garden_mcp.png){#fig-mcp-digital-garden width="70%" fig-align="center"}

![Managing MCP servers in Antigravity](../figs/screenshot_2025-12-01_manage_mcp_servers.png){#fig-mcp-manage width="70%" fig-align="center"}

Setting up Context7 in Google Antigravity
:::
