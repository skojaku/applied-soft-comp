...
![](https://cdn.thenewstack.io/media/2025/11/9fa23e7d-googleantigravitylogo-whitebackground.png)
...
The critical step is **Plan**. If the plan is flawed, the code will be flawed.

# Exercise 1: Build Space Invaders Game

![](https://segadoes.com/wp-content/uploads/2014/07/space-invaders-japan000.jpg){width="50%" fig-align="center"}
...
*   *Check*: Does it use `uv` to manage dependencies?
