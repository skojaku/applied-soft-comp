...
class GenerateRandomTool(Tool):
    ...
    inputs = {
        ...
        "std": {"type": "number", "description": "Standard deviation of the distribution", "nullable": True},
        "size": {"type": "integer", "description": "Number of samples to generate", "nullable": True}
    }
    output_type = "string"
...
class CalculateStatsTool(Tool):
    ...
    description = "Calculates statistics (mean, std, median, min, max) from a list of numbers"
    inputs = {
