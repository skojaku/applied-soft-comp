...
First, install smolagents:

```bash
pip install smolagents
```

Now let's define our tools as proper `smolagents` Tool objects:
...
class GenerateRandomTool(Tool):
    ...
    inputs = {
        "mean": {"type": "number", "description": "Mean of the distribution"},
        "std": {"type": "number", "description": "Standard deviation of the distribution"},
        "size": {"type": "integer", "description": "Number of samples to generate"}
    }
    output_type = "string"
