...
But reality has a heavy tail. Consider the signal-to-noise problem in "I deposited money at the bank." This sentence contains seven words. The relevant context—"deposited" and "money"—comprises only two words. The noise—"I," "at," "the"—comprises five. The signal-to-noise ratio is roughly 0.29. The useful information drowns in a sea of **function words** (articles, prepositions) that carry minimal semantic weight.

In a perfect world, all words contribute equally to meaning. In reality, **a small subset of words carry disproportionate semantic weight**. This is a classic **heavy-tail distribution**: most weights should hover near zero; a few should spike high. Uniform averaging treats the definite article "the" with the same importance as the verb "deposited." This is mathematically democratic but semantically catastrophic. We need a mechanism that **selectively attends** to relevant words and ignores the rest.
