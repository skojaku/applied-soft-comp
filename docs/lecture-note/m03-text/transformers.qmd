...
{
  // Create sliders
  const bankSlider = sliderWithLabel(0, 1, 0.01, 200, 1.0, "Bank Weight");
  const moneySlider = sliderWithLabel(0, 1, 0.01, 200, 0.0, "Money Weight");
  const riverSlider = sliderWithLabel(0, 1, 0.01, 200, 0.0, "River Weight");
