...
viewof bankWeight = {
  const slider = d3.sliderBottom()
    .min(0).max(1).step(0.01).width(200).default(1.0);
  const svg = d3.create("svg").attr("width", 250).attr("height", 60);
  svg.append("g").attr("transform", "translate(25,20)").call(slider);
  svg.append("text").attr("x", 125).attr("y", 10).attr("text-anchor", "middle").style("font-size", "12px").text("Bank Weight");
  return svg.node();
}

viewof moneyWeight = {
  const slider = d3.sliderBottom()
    .min(0).max(1).step(0.01).width(200).default(0.0);
  const svg = d3.create("svg").attr("width", 250).attr("height", 60);
  svg.append("g").attr("transform", "translate(25,20)").call(slider);
  svg.append("text").attr("x", 125).attr("y", 10).attr("text-anchor", "middle").style("font-size", "12px").text("Money Weight");
  return svg.node();
}
...
viewof riverWeight = {
  ...
  const svg = d3.create("svg").attr("width", 250).attr("height", 60);
  svg.append("g").attr("transform", "translate(25,20)").call(slider);
  svg.append("text").attr("x", 125).attr("y", 10).attr("text-anchor", "middle").style("font-size", "12px").text("River Weight");
  return svg.node();
}
...
viewof qScaleX = {
  const slider = d3.sliderBottom().min(-2).max(2).step(0.1).width(180).default(1.0);
  const svg = d3.create("svg").attr("width", 220).attr("height", 50);
  svg.append("g").attr("transform", "translate(20,15)").call(slider);
  svg.append("text").attr("x", 110).attr("y", 10).attr("text-anchor", "middle").style("font-size", "11px").text("Q Scale X");
  return svg.node();
}
...
viewof qScaleY = {
  ...
  const svg = d3.create("svg").attr("width", 220).attr("height", 50);
  svg.append("g").attr("transform", "translate(20,15)").call(slider);
  svg.append("text").attr("x", 110).attr("y", 10).attr("text-anchor", "middle").style("font-size", "11px").text("Q Scale Y");
  return svg.node();
}

viewof qRotate = {
  const slider = d3.sliderBottom().min(-180).max(180).step(5).width(180).default(0);
  const svg = d3.create("svg").attr("width", 220).attr("height", 50);
  svg.append("g").attr("transform", "translate(20,15)").call(slider);
  svg.append("text").attr("x", 110).attr("y", 10).attr("text-anchor", "middle").style("font-size", "11px").text("Q Rotate (deg)");
  return svg.node();
}
...
viewof kScaleX = {
  ...
  const svg = d3.create("svg").attr("width", 220).attr("height", 50);
  svg.append("g").attr("transform", "translate(20,15)").call(slider);
  svg.append("text").attr("x", 110).attr("y", 10).attr("text-anchor", "middle").style("font-size", "11px").text("K Scale X");
  return svg.node();
}
...
viewof kScaleY = {
  ...
  const svg = d3.create("svg").attr("width", 220).attr("height", 50);
  svg.append("g").attr("transform", "translate(20,15)").call(slider);
  svg.append("text").attr("x", 110).attr("y", 10).attr("text-anchor", "middle").style("font-size", "11px").text("K Scale Y");
  return svg.node();
}
...
viewof kRotate = {
  ...
  const svg = d3.create("svg").attr("width", 220).attr("height", 50);
  svg.append("g").attr("transform", "translate(20,15)").call(slider);
  svg.append("text").attr("x", 110).attr("y", 10).attr("text-anchor", "middle").style("font-size", "11px").text("K Rotate (deg)");
  return svg.node();
}
