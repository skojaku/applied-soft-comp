...
**But how do transformers create contextual embeddings?** How does "bank" get different representations in different sentences? That's the magic of the **attention mechanism**, which we'll unbox next.
