...
- [CNN Explainer](https://poloclub.github.io/cnn-explainer/) shows how convolution, activation, and pooling work step-by-step
- [Interactive Node-Link Visualization](https://adamharley.com/nn_vis/cnn/2d.html) lets you see activations flow through a trained network
:::
...
1. Collect 100-500 images per class (even phone camera photos work)
2. Split into train/val/test sets (70/15/15)
3. Start with ResNet-50 feature extraction
