...
```{figure} https://ai.stanford.edu/~syyeung/cvweb/Pictures1/imagematrix.png
---
width: 80%
name: image-matrix
align: center
...
1. Extract and visualize a small patch of pixels as numbers
2. Modify some pixel values and see how the image changes
3. Swap the red and blue channels to see the color shift
4. Convert between NumPy and PyTorch formats
