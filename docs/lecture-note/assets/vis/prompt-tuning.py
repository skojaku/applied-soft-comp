...
def _(mo):
    mo.md("""
    <center><b> With chain prompting</b></center>
    """)
    return
...
def _():
    ...
    return BaseModel, json, json_schema


@app.cell(hide_code=True)
def _(mo):
    mo.md("""
    We will use `ollama` package, instead of langchain, that supports the constrained sampling.
    """)
    return
...
def _(mo):
    mo.md("""
    <center><b>Without examples</b></center>
    """)
    return
...
def _(mo):
    mo.md("""
    <center><b>With an example</b></center>
    """)
    return
...
def _(mo):
    mo.md(r"""
    Under the hood, DSPy uses a prompt template to generate the prompt for the LLM for the given signature. You can inspect the prompt as follows:
    """)
    return
...
def _(mo):
    mo.md(r"""
    You can create a more complex signature by defining subclassing the Signature class.
    """)
    return
...
def _(mo):
    mo.md(r"""
    Note that the docstring of the signature is used to generate the prompt for the LLM.
    """)
    return
...
def _(mo):
    mo.md(r"""
    Reasoning is also supported in DSPy.
    """)
    return
