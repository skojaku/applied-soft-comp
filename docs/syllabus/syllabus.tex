...
\begin{minipage}{5in}
\begin{flushleft}
M0: Introduction \dotfill ~ 01/21 (Week 1) \\
M1: The Data Scientist's Toolkit \dotfill ~ 01/28 (Week 2) \\
M1: The Data Scientist's Toolkit (cont) \dotfill ~ 02/04 (Week 3) \\
M2: Visualizing Complexity \dotfill ~ 02/11 (Week 4) \\
M2: Visualizing Complexity (cont) \dotfill ~ 02/18 (Week 5) \\
M3: Agentic Coding \dotfill ~ 02/25 (Week 6) \\
M3: Agentic Coding (cont) \dotfill ~ 03/04 (Week 7) \\
(No Class - Spring Break) \dotfill ~ 03/11 (Week 8) \\
M4: Deep Learning for Text \dotfill ~ 03/18 (Week 9) \\
M4: Deep Learning for Text (cont) \dotfill ~ 03/25 (Week 10) \\
M4: Deep Learning for Text (cont) \dotfill ~ 04/01 (Week 11) \\
M5: Deep Learning for Images \dotfill ~ 04/08 (Week 12) \\
M5: Deep Learning for Images (cont) \dotfill ~ 04/15 (Week 13) \\
M6: Deep Learning for Graphs \dotfill ~ 04/22 (Week 14) \\
M6: Deep Learning for Graphs (cont) \dotfill ~ 04/29 (Week 15) \\
M7: Representations \& Structuralism \dotfill ~ 05/06 (Week 16) \\
Final Exam Week \dotfill ~ 05/12-05/16 (Week 17) \\
\end{flushleft}
\end{minipage}
\end{center}
