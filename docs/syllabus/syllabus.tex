...
\item Course Website \url{https://skojaku.github.io/applied-soft-computing}
\item Course Github \url{http://github.com/skojaku/applied-soft-computing}
\end{enumerate}
...
\begin{minipage}{5in}
\begin{flushleft}
Introduction to Neural Networks \dotfill ~ 01/20 (Week 1) \\
Word2Vec: Learning Word Embeddings \dotfill ~ 01/27 (Week 2) \\
Tokenization and Text Preprocessing \dotfill ~ 02/03 (Week 3) \\
Transformers: Architecture and Attention Mechanism \dotfill ~ 02/10 (Week 4) \\
BERT: Bidirectional Encoders for Language Understanding \dotfill ~ 02/17 (Week 5) \\
Sentence Embeddings and Their Applications \dotfill ~ 02/24 (Week 6) \\
Recurrent Neural Networks (RNNs) and LSTMs \dotfill ~ 03/03 (Week 7) \\
(No Class - Spring Break) \dotfill ~ 03/10 (Week 8) \\
Convolutional Neural Networks and Fourier Transforms \dotfill ~ 03/17 (Week 9) \\
Topic Modeling with BERT \dotfill ~ 03/24 (Week 10) \\
Generative Language Models: GPT and Beyond \dotfill ~ 03/31 (Week 11) \\
Parameter-Efficient Fine-Tuning (PEFT) \dotfill ~ 04/07 (Week 12) \\
Advanced Topics in Neural Networks \dotfill ~ 04/14 (Week 13) \\
Project working session \dotfill ~ 04/21 (Week 14; no class on 04/22) \\
Project Presentations \dotfill ~ 04/26 (Week 15) \\
Course Wrap-up and Future Directions \dotfill ~ 05/05 (Week 16; no class on 05/08) \\
