...
\textbf{Instructor:} & Sadamori Kojaku & & &  & \textbf{Time:} & Tue \& Thur 1:30 PM -- 3:00 PM \\
...
\textbf{Office Hour:} &  3:00 PM-5:00 PM Mon \& Wed & & & & \textbf{Zoom:} & \href{https://binghamton.zoom.us/my/skojaku.zoom}{my/skojaku.zoom}
\end{tabular}
\end{minipage}
\rule{6in}{0.4pt}
\end{center}
...
All materials are available on the course GitHub repository at \url{https://github.com/skojaku/applied-soft-comp}. Slides will not be provided prior to the lecture (we don't want to give you a spoiler). Lecture notes are available at \url{https://skojaku.github.io/applied-soft-comp}.

\vskip.15in
\noindent\textbf{Office Hours:} Mondays 3:00 PM-5:00 PM and Wednesdays 3:00 PM-5:00 PM or by appointment (in person and online). For TA office hours, Monday 10:30 AM-1:00 PM and Wednesday 11:00 AM-1:30 PM, for Ramin Naderi Beni.
...
\begin{minipage}{5in}
\begin{flushleft}
M1: The Data Scientist's Toolkit \dotfill ~ 01/20 (Week 1) \\
M1: The Data Scientist's Toolkit (cont) \dotfill ~ 01/27 (Week 2) \\
M2: Visualizing Complexity \dotfill ~ 02/03 (Week 3) \\
M2: Visualizing Complexity (cont) \dotfill ~ 02/10 (Week 4) \\
M3: Agentic Coding \dotfill ~ 02/17 (Week 5) \\
M3: Agentic Coding (cont) \dotfill ~ 02/24 (Week 6) \\
M4: Deep Learning for Text \dotfill ~ 03/03 (Week 7) \\
M4: Deep Learning for Text (cont) \dotfill ~ 03/10 (Week 8) \\
M4: Deep Learning for Text (cont) \dotfill ~ 03/17 (Week 9) \\
M5: Deep Learning for Images \dotfill ~ 03/24 (Week 10) \\
(No Class - Spring Break) \dotfill ~ 03/28 - 04/06 \\
M5: Deep Learning for Images (cont) \dotfill ~ 04/07 (Week 11) \\
M6: Deep Learning for Graphs \dotfill ~ 04/14 (Week 12) \\
M6: Deep Learning for Graphs (cont) \dotfill ~ 04/21 (Week 13) \\
M7: Representations \& Structuralism \dotfill ~ 04/28 (Week 14) \\
M7: Representations \& Structuralism (cont) \dotfill ~ 05/05 (Week 15) \\
Final Exam Week \dotfill ~ 05/08 - 05/14 \\
\end{flushleft}
\end{minipage}
\end{center}
...
\begin{itemize}
\item \textit{In-class (20\%)}: Attendance (5\%), In-class quiz (5\%), Sprint project (10\%).
\item \textit{Assignment (20\%)}: Coding (5\%), Module quiz (5\%), LLM quiz challenge (10\%).
\item \textit{Project (30\%)}: Project proposal (10\%), Project paper (20\%).
\item \textit{Final Exam (30\%)}.
...
The primary goal of this course is to \textbf{feel} the concepts and tools through pen-and-paper exercises and hands-on coding.
The course will first cover practical skills, followed by their theoretical foundations.
The course activities include:
\begin{itemize}
\item Weekly quiz on Brightspace about the lecture topics in the previous week to review and test your understanding of the concepts and tools.
\item Coding assignments on Github Classroom for practicing and equipping you with the skills to analyze data.
\item 90-minute ``Mini'' in-class project: Form a team of 2 to 4 people. A task will be given and you must solve the task and document the work. Randomly-chosen teams will present their work. Submit the work to GitHub with a specified format.
\item Short lectures to cover the theoretical aspects.
\end{itemize}

\vskip.15in
\noindent\textbf{Module Quiz:}
You will be given quiz questions on each module. Questions are personalized based on your level of understanding. The format is free-write, and you must complete each quiz by the specific due date for that module.

\vskip.15in
\noindent\textbf{LLM Quiz Challenge:}
We switch roles: you become the instructor and an AI tutor becomes the student. You compose quiz questions for the AI tutor and you'll win (pass) when your quiz questions stump the tutor. All questions must be approved by the instructor.

\vskip.15in
\noindent\textbf{Final Exam:}
The final exam will be a take-home, open-book format on Brightspace. The exam includes 60 questions in multiple choice and short text formats. You will have 60 minutes to complete the exam once you begin.

\vskip.15in
\noindent\textbf{Project:}
\textit{Proposal:} No page limit. You may form a team. Describe your idea and plan, and provide literature review explaining why we should care about your project.

\textit{Paper:} Include Introduction, Methods, and Results sections. We focus on the process, not the results.

\textit{Presentation:} 12 minutes presentation and 3 minutes Q\&A. You will present your project to the class. 
...
\begin{itemize}
    \item \textbf{Sadamori Kojaku:} 3:00 PM-5:00 PM Mondays and Wednesdays at J19 Engineering Building (in person) or Zoom (\url{https://binghamton.zoom.us/my/skojaku.zoom}).
    \item \textbf{Ramin Naderi Beni:} 10:30 AM-1:00 PM Mondays and 11:00 AM-1:30 PM Wednesdays at J19 Engineering Building (in person).
\end{itemize}
...
\begin{itemize}
    \item \textbf{Attendance}: Please inform us if you cannot attend class at least one day in advance by submitting the form at \url{https://forms.gle/74atpKqHMoMajALf6}. If you fail to notify us in advance, in principle, we do not accept the excuse. Acceptable excuses for missing class include illness or conference travel.
    ...
    \item \textbf{Generative AI}: Students are encouraged to make use of technology, including generative AI tools, to contribute to their understanding of course materials. Students may use artificial intelligence tools, including generative AI, in this course as learning aids or to help produce assignments. However, students are ultimately accountable for the work they submit. Any content produced by an artificial intelligence tool must be cited appropriately (e.g., MLA: \url{https://style.mla.org/citing-generative-ai/}). Students may choose to use generative AI tools as they work through the assignments in this course. When an assignment includes a section for AI usage documentation, students must document what tool(s) were used, how they were used, and how the results from the AI were incorporated into the submitted work.
