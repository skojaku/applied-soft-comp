...
M2: RNNs (cont) \dotfill ~ 02/10 (Week 4) \\
M3: RNNs \& Project matchmaking \dotfill ~ 02/17 (Week 5) \\
Data Visualization \dotfill ~ 02/24 (Week 6) \\
M3: Transformers \dotfill ~ 03/03 (Week 7) \\
(No Class - Spring Break) \dotfill ~ 03/10 (Week 8) \\
M3: Transformers (cont) \dotfill ~ 03/17 (Week 9) \\
M4: Transformers (cont) \dotfill ~ 03/24 (Week 10) \\
M5: Image Processing \dotfill ~ 03/31 (Week 11) \\
M5: Image Processing (cont) \dotfill ~ 04/07 (Week 12) \\
M6: Graph Neural Networks \dotfill ~ 04/14 (Week 13) \\
M6: Graph Neural Networks (cont) \dotfill ~ 04/21 (Week 14; no class on 04/22) \\
