...
\begin{minipage}{5in}
\begin{flushleft}
M0: Introduction \dotfill ~ 01/20 (Week 1) \\
M1: The Data Scientist's Toolkit \dotfill ~ 01/27 (Week 2) \\
M1: The Data Scientist's Toolkit (cont) \dotfill ~ 02/03 (Week 3) \\
M2: Visualizing Complexity \dotfill ~ 02/10 (Week 4) \\
M2: Visualizing Complexity (cont) \dotfill ~ 02/17 (Week 5) \\
M3: Agentic Coding \dotfill ~ 02/24 (Week 6) \\
M3: Agentic Coding (cont) \dotfill ~ 03/03 (Week 7) \\
M4: Deep Learning for Text \dotfill ~ 03/10 (Week 8) \\
M4: Deep Learning for Text (cont) \dotfill ~ 03/17 (Week 9) \\
M4: Deep Learning for Text (cont) \dotfill ~ 03/24 (Week 10) \\
(No Class - Spring Break) \dotfill ~ 03/28 - 04/06 \\
M5: Deep Learning for Images \dotfill ~ 04/07 (Week 11) \\
M5: Deep Learning for Images (cont) \dotfill ~ 04/14 (Week 12) \\
M6: Deep Learning for Graphs \dotfill ~ 04/21 (Week 13) \\
M6: Deep Learning for Graphs (cont) \dotfill ~ 04/28 (Week 14) \\
M7: Representations \& Structuralism \dotfill ~ 05/05 (Week 15) \\
