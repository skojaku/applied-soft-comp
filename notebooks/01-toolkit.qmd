...
> [!NOTE]
> If you don't have `uv` installed yet, you can install it by following the instructions at [https://docs.astral.sh/uv/](https://docs.astral.sh/uv/). On macOS and Linux, you can use `curl -LsSf https://astral.sh/uv/install.sh | sh`. On Windows, use `powershell -ExecutionPolicy ByPass -c "irm https://astral.sh/uv/install.ps1 | iex"`.
...
> [!TIP]
> Make sure you're inside the cloned directory (`cd 01-toolkit-YOUR-USERNAME`) before running any git commands in the exercises below.
...
>
> Your instructor will review your work directly on GitHub Classroom.
>
