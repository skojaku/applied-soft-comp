...
**Step 1:** Accept the assignment invitation link provided on Brightspace. This creates a personal repository for you on GitHub.

**Step 2:** After accepting, you'll be redirected to your repository page. Click the green **"Code"** button, make sure **"HTTPS"** is selected, and copy the repository URL. It will look like:

```
https://github.com/sk-classroom/git-practice-assignment-YOUR-USERNAME.git
```

**Step 3:** Clone the repository to your computer. Open your terminal and navigate to where you want to work (like your Documents folder or a projects directory):
...
Replace `YOUR-USERNAME` with your actual GitHub username. This creates a local copy of your repository that's already connected to GitHub.

Now you're ready to start the exercises. The repository is already initialized (GitHub did that for you), and it's already connected to a remote server. You can focus on learning Git commands without worrying about setup.
...
After completing all the Git exercises, make sure you've pushed everything to GitHub, then submit on Brightspace.

**Pre-submission checklist:**

Visit your repository on GitHub and verify you see:

- [ ] The `analysis.py` file with both `calculate_mean()` and `calculate_median()` functions
- [ ] At least 5 commits in your commit history
- [ ] Multiple branches visible in the branches dropdown: `main`, `add-median`, `use-numpy-mean`, `add-mean-docstring`
- [ ] A merge commit showing conflict resolution (check the commit history)

**To submit:**

1. Copy your repository URL from the browser address bar (it looks like: `https://github.com/sk-classroom/git-practice-assignment-yourname`)
2. Submit this URL on Brightspace in the toolkit assignment

Your instructor will review your repository to verify you've completed all exercises. This demonstrates you're ready to use version control throughout the course.
:::
