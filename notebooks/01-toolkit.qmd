...
Visit your repository page on GitHub (the same page from the setup section—you can always find it at `https://github.com/sk-classroom/git-practice-assignment-YOUR-USERNAME`). Verify you see:
